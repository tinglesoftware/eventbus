...
internal class AmazonSqsConfigureOptions(IEventBusConfigurationProvider configurationProvider,
                                         IEnumerable<IEventBusConfigurator> configurators,
                                         IOptions<EventBusOptions> busOptionsAccessor)
    : AmazonTransportConfigureOptions<AmazonSqsTransportOptions>(configurationProvider, configurators, busOptionsAccessor)
{
    /// <inheritdoc/>
