...
{
    /// <summary>
    /// Abstractions for authencating Azure-based transports without a connection strings.
    /// </summary>
    public abstract class AzureTransportCredentials
    {
        /// <summary>
        /// Credential used to authenticate requests.
        /// Depending on the transport resources, the relevant persmissions must be available in the provided credential.
