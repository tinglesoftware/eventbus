...
/// <summary>
/// The <see cref="InMemoryMessage"/> is used to receive data from InMemory queues and subscriptions.
/// </summary>
public class InMemoryReceivedMessage
{
    /// <summary>
    ...
    internal InMemoryReceivedMessage(InMemoryMessage message) : this(message?.Body ?? throw new ArgumentNullException(nameof(message)))
    {
