...
internal class KafkaConfigureOptions(IEventBusConfigurationProvider configurationProvider,
                                     IEnumerable<IEventBusConfigurator> configurators,
                                     IOptions<EventBusOptions> busOptionsAccessor)
    : EventBusTransportConfigureOptions<KafkaTransportOptions>(configurationProvider, configurators, busOptionsAccessor)
{
    /// <inheritdoc/>
